...
exports.dbConnection = exports.addDBtoApp = void 0;
var dbPool_1 = require("../database/dbPool");
var addDBtoApp = function (context) { return __awaiter(void 0, void 0, void 0, function () {
    var connection;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dbPool_1.default.getConnection()];
            case 1:
                connection = _a.sent();
...
var dbConnection = function (ctx, next) { return __awaiter(void 0, void 0, void 0, function () {
    var connection;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dbPool_1.default.getConnection()];
